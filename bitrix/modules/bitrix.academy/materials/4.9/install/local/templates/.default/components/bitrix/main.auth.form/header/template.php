...
$page = $arParams["AUTH_PAGE"] . "?backurl=" . urlencode($request->getRequestUri());
?>
		...
		<div class="user-thumbnail">
			<div class="user-thumbnail__control">
				<?php if ($arResult['AUTHORIZED']): ?>
					<a class="btn btn-outline-primary rounded-pill w-100" role="button"
					   href="<?=$arParams["PERSONAL_PAGE"]?>?personal_backurl=Y">
